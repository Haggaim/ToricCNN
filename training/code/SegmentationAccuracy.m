    ...
    methods
        function outputs = forward(obj, inputs, params)
            ...
            obj.confusion = obj.confusion + ...
                accumarray([labels(ok),predictions(ok)],1,[numClasses numClasses]) ;
            ...
            else % head segmentation case
                headClass = 2;
                obj.pixelAccuracy = sum(predictions(:)==headClass & labels(:)==headClass)/sum(predictions(:)==headClass | labels(:)==headClass);
            end
